...
(function($) {
    ...
    function _45(_46, _47) {
        ...
        function _4a(_4b) {
            var _4c = _4b ? 1 : 2;
            var tr = _49.finder.getTr(_46, _47, "body", _4c); (_4b ? dc.body1: dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
    ...
    function _199(_19a) {
        ...
        function _1a2(ids, _1a3) {
            for (var i = 0; i < ids.length; i++) {
                ...
                if (_1a4 >= 0) { (_1a3 == "s" ? _a5: _a2)(_19a, _1a4, true);
                }
            }
        };
    ...
    function _bf(_1a7, _1a8, cb) {
        ...
        var _1aa = opts.loader.call(_1a7, _1a9,
        function(data) {
        ...
        return this.each(function() {
            ...
            if (_1b2) {
                ...
                $.fn.datagrid.defaults, {
                    queryParams: {}
                }), $.fn.datagrid.parseOptions(this), _1b0);
    ...
    var _1c2 = $.extend({},
    _1b4(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function(_208) {
        var t = $(_208);
        return $.extend({},
        $.fn.panel.parseOptions(_208), $.parser.parseOptions(_208, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _20b = {
        ...
        renderEmptyRow: function(_24e) {
            var cols = $.map($(_24e).datagrid("getColumnFields"),
            function(_24f) {
