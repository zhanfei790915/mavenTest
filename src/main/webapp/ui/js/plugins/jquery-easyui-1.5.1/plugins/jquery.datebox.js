...
(function($) {
    function _1(_2) {
        ...
        var _4 = _3.options;
        $(_2).addClass("datebox-f").combo($.extend({},
        _4, {
        ...
        function _5(_c) {
            ...
            _e.unbind(".datebox").bind("click.datebox",
            function(e) {
    ...
    $.fn.datebox = function(_24, _25) {
        ...
        return this.each(function() {
            ...
            if (_27) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({},
                    $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _24)
                });
            }
            _1(this);
        });
    ...
    $.fn.datebox.parseOptions = function(_2f) {
        return $.extend({},
        $.fn.combo.parseOptions(_2f), $.parser.parseOptions(_2f, ["sharedCalendar"]));
    };
