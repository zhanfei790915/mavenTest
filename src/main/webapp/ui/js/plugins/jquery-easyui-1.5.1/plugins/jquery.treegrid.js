...
(function($) {
    ...
    function _15(_63, _64, _65, _66, _67) {
        ...
        var _6c = _68.loader.call(_63, _6a,
        function(_6d) {
    ...
    function _8a(_8b, _8c) {
        ...
        if (_8e.length) {
            ...
            _15(_8b, row[_8d.idField], _90, true,
            function() {
                if (cc.is(":empty")) {
                    _8e.remove();
                } else {
        ...
        return this.each(function() {
            ...
            if (_cf) {
                ...
                _cf = $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _cc),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.parseOptions = function(_e4) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_e4), $.parser.parseOptions(_e4, ["treeField", {
            checkbox: "boolean",
