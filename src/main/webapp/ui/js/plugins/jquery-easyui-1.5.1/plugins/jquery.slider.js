...
(function($) {
            ...
            for (var i = 0; i < aa.length; i++) {
                ...
                if (aa[i] != "|") {
                    ...
                    if (_10.mode == "h") {
                        _16.css({
                            left: _15,
                            marginLeft: -Math.round(_16.outerWidth() / 2)
                        });
                    } else {
                        _16.css({
                            top: _15,
                            marginTop: -Math.round(_16.outerHeight() / 2)
                        });
                    }
                }
            }
    ...
    function _24(_25, _26) {
        ...
        var _2b = [];
        if (!$.isArray(_26)) {
            _26 = $.map(String(_26).split(_28.separator),
            function(v) {
                return parseFloat(v);
            });
        }
        ...
        return this.each(function() {
            ...
            if (_42) {
                ...
                _42 = $.data(this, "slider", {
                    options: $.extend({},
                    $.fn.slider.defaults, $.fn.slider.parseOptions(this), _40),
                    slider: _1(this)
                });
            ...
            if (_43.range) {
                if (!$.isArray(_43.value)) {
                    _43.value = $.map(String(_43.value).split(_43.separator),
                    function(v) {
                        return parseFloat(v);
                    });
                }
    ...
    $.fn.slider.parseOptions = function(_49) {
        var t = $(_49);
        return $.extend({},
        $.parser.parseOptions(_49, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
