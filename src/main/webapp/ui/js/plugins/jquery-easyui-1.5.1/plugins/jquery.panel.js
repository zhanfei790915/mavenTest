...
(function($) {
        ...
        function _1e() {
            if (_1c.noheader || (!_1c.title && !_1c.header)) {
                ...
                if (_1c.header) {
                    ...
                    if (_1c.minimizable) {
                        _26(_25, "panel-tool-min",
                        function() {
                            _5a(_1a);
                        });
                    }
                    if (_1c.maximizable) {
                        _26(_25, "panel-tool-max",
                        function() {
    ...
    $.fn.panel = function(_68, _69) {
        ...
        return this.each(function() {
            ...
            if (_6a) {
                ...
                _6b = $.extend({},
                $.fn.panel.defaults, $.fn.panel.parseOptions(this), _68);
                $(this).attr("title", "");
                _6a = $.data(this, "panel", {
                    options: _6b,
                    panel: _15(this),
    ...
    $.fn.panel.parseOptions = function(_7c) {
        ...
        return $.extend({},
        $.parser.parseOptions(_7c, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "method", "header", "footer", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
