...
(function($) {
        ...
        return this.each(function() {
            ...
            if (_5c) {
                ...
                _5c = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _59),
                    data: []
                });
            }
            _44(this);
    ...
    $.fn.combobox.parseOptions = function(_68) {
        var t = $(_68);
        return $.extend({},
        $.fn.combo.parseOptions(_68), $.parser.parseOptions(_68, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
