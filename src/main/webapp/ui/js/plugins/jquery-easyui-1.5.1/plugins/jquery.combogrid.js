...
(function($) {
    function _1(_2) {
        ...
        var _4 = _3.options;
        var _5 = _3.grid;
        $(_2).addClass("combogrid-f").combo($.extend({},
        _4, {
    ...
    function _20(_27, _28, _29) {
        ...
        var _35 = $.grep(_2c.datagrid("getSelections"),
        function(row, _36) {
    ...
    function _46(_47) {
        ...
        var vv = [];
        $.map(_4a.datagrid("getSelections"),
        function(row) {
            vv.push(row[_49.idField]);
        });
        $.map(_49.unselectedValues,
        function(v) {
        ...
        return this.each(function() {
            ...
            if (_4f) {
                ...
                _4f = $.data(this, "combogrid", {
                    options: $.extend({},
                    $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _4c)
                });
            }
            _1(this);
        });
    ...
    $.fn.combogrid.parseOptions = function(_57) {
        var t = $(_57);
        return $.extend({},
        $.fn.combo.parseOptions(_57), $.fn.datagrid.parseOptions(_57), $.parser.parseOptions(_57, ["idField", "textField", "mode"]));
    };
