...
(function($) {
    ...
    function _9(_a) {
        ...
        _c.find(".calendar-menu-year").unbind(".calendar").bind("keypress.calendar",
        function(e) {
            if (e.keyCode == 13) {
                _d(true);
            }
        });
        $(_a).unbind(".calendar").bind("mouseover.calendar",
        function(e) {
            var t = _e(e.target);
        ...
        return this.each(function() {
            ...
            if (_3f) {
                ...
                _3f = $.data(this, "calendar", {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _3d)
                });
                _6(this);
            }
    ...
    $.fn.calendar.parseOptions = function(_44) {
        var t = $(_44);
        return $.extend({},
        $.parser.parseOptions(_44, ["weekNumberHeader", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean",
            showWeek: "boolean"
