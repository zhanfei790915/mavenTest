...
(function($) {
    function _1(_2) {
        ...
        $(_2).addClass("passwordbox-f").textbox($.extend({},
        _4, {
            icons: _5
        }));
        _6(_2);
    ...
    function _13(e) {
        ...
        _15.checking = true;
        _15.value = t.passwordbox("getText"); (function() {
            if (_15.checking) {
        ...
        return this.each(function() {
            ...
            if (_1e) {
                ...
                _1e = $.data(this, "passwordbox", {
                    options: $.extend({},
                    $.fn.passwordbox.defaults, $.fn.passwordbox.parseOptions(this), _1b)
                });
            }
            _1(this);
        });
    ...
    $.fn.passwordbox.parseOptions = function(_22) {
        return $.extend({},
        $.fn.textbox.parseOptions(_22), $.parser.parseOptions(_22, ["passwordChar", {
