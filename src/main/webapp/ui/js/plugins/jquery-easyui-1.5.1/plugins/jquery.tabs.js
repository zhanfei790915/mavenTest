...
(function($) {
        ...
        if (_f.tools) {
            if (typeof _f.tools == "string") {
                ...
                for (var i = 0; i < _f.tools.length; i++) {
                    ...
                    _12[0].onclick = eval(_f.tools[i].handler ||
                    function() {});
                    _12.linkbutton($.extend({},
                    _f.tools[i], {
                        plain: true
                    }));
                }
    ...
    function _2e(_2f) {
        ...
        var _31 = _30.options;
        $(_2f).children("div.tabs-header").unbind().bind("click",
        function(e) {
    ...
    $.fn.tabs = function(_83, _84) {
        ...
        return this.each(function() {
            ...
            if (_85) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({},
                    $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _83),
                    tabs: [],
                    selectHis: []
                });
                _28(this);
    ...
    $.fn.tabs.parseOptions = function(_97) {
        return $.extend({},
        $.parser.parseOptions(_97, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
        },
