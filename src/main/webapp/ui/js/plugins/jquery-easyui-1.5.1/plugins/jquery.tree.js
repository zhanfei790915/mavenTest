...
(function($) {
    ...
    function _3c(_3f, _40, _41) {
        ...
        _3e(_3f, _40, _43);
        if (_42.deepCheck) {
            $.easyui.forEach(_40.children || [], true,
            function(n) {
                _3e(_3f, n, _43);
            });
        } else {
    ...
    function _6f(_70, ul, _71, _72) {
        ...
        var _77 = _73.loader.call(_70, _71,
        function(_78) {
    ...
    function _c9(_ca, _cb) {
        var _cc = _c(_ca, _cb);
        if (_cc && _cc.children) {
            $.easyui.forEach(_cc.children, true,
            function(_cd) {
                _ba(_cd);
            });
        }
    ...
    $.fn.tree = function(_f9, _fa) {
        ...
        return this.each(function() {
            ...
            if (_fb) {
                ...
                _fc = $.extend({},
                $.fn.tree.defaults, $.fn.tree.parseOptions(this), _f9);
                $.data(this, "tree", {
                    options: _fc,
                    tree: _1(this),
                    data: [],
    ...
    $.fn.tree.parseOptions = function(_119) {
        var t = $(_119);
        return $.extend({},
        $.parser.parseOptions(_119, ["url", "method", {
            checkbox: "boolean",
