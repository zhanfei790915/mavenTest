...
(function($) {
    function _1(_2) {
        ...
        var _4 = _3.options;
        $(_2).addClass("combotreegrid-f").combo($.extend({},
        _4, {
    ...
    function _11(_12) {
        ...
        var vv = [];
        if (_14.multiple) {
            vv = $.map(_15.treegrid("getCheckedNodes"),
            function(row) {
    ...
    function _16(_17, _18) {
        ...
        $.map(_1b.treegrid("getCheckedNodes"),
        function(row) {
            ...
            if (q) {
                ...
                function(q) {
                    ...
                    if (q) {
                        ...
                        if (v == undefined) {
                            $.easyui.forEach(_25.mappingRows, false,
                            function(row) {
        ...
        return this.each(function() {
            ...
            if (_2d) {
                ...
                _2d = $.data(this, "combotreegrid", {
                    options: $.extend({},
                    $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this), _2a)
                });
            }
            _1(this);
        });
    ...
    $.fn.combotreegrid.parseOptions = function(_34) {
        var t = $(_34);
        return $.extend({},
        $.fn.combo.parseOptions(_34), $.fn.treegrid.parseOptions(_34), $.parser.parseOptions(_34, ["mode", {
            limitToGrid: "boolean"
        }]));
    };
