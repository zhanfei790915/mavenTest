...
(function($) {
    function _1(_2) {
        ...
        var _4 = _3.options;
        $(_2).addClass("tagbox-f").combobox($.extend({},
        _4, {
            cls: "tagbox",
            reversed: true,
    ...
    function _1c(_1d) {
        var _1e = $(_1d).next();
        _1e.unbind(".tagbox").bind("click.tagbox",
        function(e) {
    ...
    $.fn.tagbox = function(_36, _37) {
        ...
        return this.each(function() {
            ...
            if (_39) {
                ...
                $.data(this, "tagbox", {
                    options: $.extend({},
                    $.fn.tagbox.defaults, $.fn.tagbox.parseOptions(this), _36)
                });
            }
            _1(this);
            _1c(this);
    ...
    $.fn.tagbox.parseOptions = function(_3c) {
        return $.extend({},
        $.fn.combobox.parseOptions(_3c), $.parser.parseOptions(_3c, []));
    };
