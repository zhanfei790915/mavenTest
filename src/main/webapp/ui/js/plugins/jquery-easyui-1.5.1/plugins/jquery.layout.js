...
(function($) {
    ...
    function _2d(_2e, _2f, _30) {
        ...
        p.panel("panel").animate(_37.collapse, _30,
        function() {
    ...
    function _41(_42, _43) {
        ...
        if (_44[_46]) {
            ...
            p.panel("panel").animate(_47.expand,
            function() {
                _2(_42);
    ...
    $.fn.layout = function(_57, _58) {
        ...
        return this.each(function() {
            ...
            if (_59) {
                ...
                var _5a = $.extend({},
                $.fn.layout.defaults, $.fn.layout.parseOptions(this), _57);
                $.data(this, "layout", {
                    options: _5a,
                    panels: {
                        center: $(),
    ...
    $.fn.layout.parsePanelOptions = function(_68) {
        var t = $(_68);
        return $.extend({},
        $.fn.panel.parseOptions(_68), $.parser.parseOptions(_68, ["region", {
            split: "boolean",
