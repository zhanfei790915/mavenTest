...
(function($) {
    ...
    $.fn.combotree = function(_2f, _30) {
        ...
        return this.each(function() {
            ...
            if (_32) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({},
                    $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _2f)
                });
            }
            _1(this);
        });
    ...
    $.fn.combotree.parseOptions = function(_3f) {
        return $.extend({},
        $.fn.combo.parseOptions(_3f), $.fn.tree.parseOptions(_3f));
    };
