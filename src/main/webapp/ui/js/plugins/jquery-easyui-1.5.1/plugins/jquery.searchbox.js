...
(function($) {
    function _1(_2) {
        ...
        _7();
        var _8 = _9();
        $(_2).addClass("searchbox-f").textbox($.extend({},
        _4, {
            icons: _5,
    ...
    $.fn.searchbox = function(_11, _12) {
        ...
        return this.each(function() {
            ...
            if (_14) {
                ...
                $.data(this, "searchbox", {
                    options: $.extend({},
                    $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _11)
                });
            }
            _1(this);
        });
    ...
    $.fn.searchbox.parseOptions = function(_1a) {
        var t = $(_1a);
        return $.extend({},
        $.fn.textbox.parseOptions(_1a), $.parser.parseOptions(_1a, ["menu"]), {
